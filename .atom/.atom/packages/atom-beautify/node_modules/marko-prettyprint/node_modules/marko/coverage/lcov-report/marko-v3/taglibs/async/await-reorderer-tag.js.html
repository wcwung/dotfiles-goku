...
<html lang="en">
<head>
    <title>Code coverage report for marko-v3/taglibs/async/await-reorderer-tag.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v3/taglibs/async/</a> await-reorderer-tag.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!awaitContext || !awaitContext.instances.length) {
